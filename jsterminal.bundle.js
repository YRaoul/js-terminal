(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.jsterminal = {}));
})(this, (function (exports) { 'use strict';

	function check_document (doc = document) {
	...
	function get_container (selector, doc=document) {
	 ...
	 * @return 
	 */
	function make_terminal (doc=document, options={}) {
		options = {
			prefix: "> ",
			no_style: false,
			...options
